...
export const TECH_HIGHLIGHTS: TechHighlight[] = [
  ...
  },
  {
    ...
    languages: ["python"],
    bullets: [
      "Authentication and authorization are separate: the `Auth` middleware only populates `connection.user`, while `guards=[...]` is what actually blocks a handler — a handler with no guard is reachable by anyone",
